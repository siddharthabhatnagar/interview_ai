      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-2">
              <li>You may delete your account at any time from your dashboard. See our <a href="/account-deletion" className="text-blue-600 dark:text-blue-400 hover:underline">Account Deletion Information</a> page for details.</li>
